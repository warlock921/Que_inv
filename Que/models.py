...
class Questionnaire(models.Model):
	...
	participants = models.ManyToManyField(User,related_name="Que_participants", verbose_name="参与者")
...
class ChoiceQuestion(Question):
	...
	class Meta:
		ordering = ["questionnaire","order_in_list"]
...
class AnswerSheet(models.Model):
	"""答卷的抽象"""
	user = models.ForeignKey(User)                    #答题者
